...
const TodoistIndicator = new Lang.Class({
		...
		_refreshUI: function (data) {
			...
			let count = _openItems.filter(Utils.isDueDateInPast).filter( item => item.project_id !== 2070804635).length;
...
function enable() {
	...
	Main.panel.addToStatusArea('todoist-indicator', todoistMenu, 2, 'left');
}
